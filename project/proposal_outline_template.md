...
Your name · EDIS 8100 · Fall 2026 · Course Research Project Outline
...
*Which theory or theories frame how you understand learning in this setting, and what do they commit you to? Name the framework, name the two or three constructs you are borrowing from it, and say what those constructs predict or make visible. Then, in one or two sentences, connect the framework to the analytics: if the theory says learning looks like X, what trace or measure would X leave behind? That sentence is the integration the rubric is looking for, and it is the single most common thing missing from outlines. Roughly half a page, bullets acceptable.*

## 3. Research Questions

*Two to four questions, numbered, written as complete sentences. Each one should be answerable with the data you are proposing to collect, and each should be traceable to the framework above. Mark which question is primary. Under each question, add one line naming the kind of evidence that would answer it, for example "a comparison of trajectories between two groups" or "a description of the sequence patterns present." A quarter page. If a question could be answered "yes" and leave you with nothing to say, it is not a research question yet.*
...
*The longest section of the outline, roughly one page across the four subsections below. It should be specific enough that a peer in week 12 could tell you whether it is feasible.*

### 5a. Data sources and collection

*What data, from where, over what period, about how many people? Name the systems, the tables, and the units. If you have access, say so and say how. If access is hypothetical, say what the request would look like and to whom. Include what would have to be collected new, such as surveys, interviews, or observations, and say why the trace data alone would not be enough.*

### 5b. Cleaning and preparation

*What state will the data plausibly arrive in, and what has to happen before analysis? Name the joins, the unit of analysis you will build toward (one row is a what?), the filters you expect to apply, and the missingness you expect to meet. Say how you will handle the missingness rather than that you will handle it. This subsection is where proposals reveal whether their author has ever actually opened an export, and it is worth being honest here.*

### 5c. Analysis

*Which methods, applied to which question? Map each research question to a specific analytic approach: descriptive comparison, regression, sequence or process mining, network analysis, topic modeling, clustering, qualitative coding, or a combination. Name the software. Say what a result would look like. If a method is new to you, say so and name the resource you will learn it from, which is a perfectly respectable outline entry.*
...
*APA 7 reference list for everything cited above. At outline stage, eight to fifteen sources is a reasonable range. They do not have to be everything you will eventually read, but every one listed here should be something you have actually read enough of to characterize accurately. The literature review milestone in week 10 will grow this list considerably.*
