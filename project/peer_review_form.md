...
Peer review runs in week 12, Project Day, Wednesday 11/11, 3:30 to 6:00 PM, Ridley 137. Each draft is read in two rounds by two different readers.
...
| **What you do before class** | Read your Round 1 partner's whole draft twice and complete a written form for it before class. Your Round 2 partner is assigned in class, so that form is written in the room. |
...
**Say what worked, and say why it worked.** This is information for the author rather than politeness. An author who does not know which parts are working will revise the wrong things. Be as specific about strengths as about problems.

**Name the level of your concern.** There is a large difference between "this citation is formatted wrong," "this paragraph is unclear," and "I do not think this design can answer this question." Say which one you are raising. Reviewers who put a structural concern inside a list of comma corrections leave the author unable to tell which comments matter most.

**Ask before you assert.** Much of what looks like an error is a decision the author made for a reason you have not been told. A question prompts the author to state the reason in the draft, where the next reader will need it too.

**Authors: listen first.** In each round, the author's job at the start is to take notes and not defend. You will get time to respond. If you argue in the first minute, the reviewer will hold back for the rest of the round.

**Authors: the revision is yours.** You are not required to take any piece of advice. You are required to be able to say why you did not.
...
There are six of us, so each round is three pairs working in parallel on the same schedule, and nobody is paired with the same person twice.

### Opening (3:30 to 3:40, 10 minutes)

Protocol overview, pair assignments, and a reminder of the norms above.

### Round 1 (3:40 to 4:40, 60 minutes, in pairs)

| Minutes | What happens |
|---|---|
| 5 | Silent settling. Re-skim your written form, sharpen your one big question. |
| 3 | **Author A frames.** Author A names what they most want feedback on, in under three minutes. Reviewer takes note of it. |
| 15 | **Reviewer speaks, author A listens and writes.** Work through the form in order: strengths first, then framework, methods, ethics and equity, actionability, big question. |
| 7 | **Dialogue.** Author A responds, asks for clarification, tests a possible revision out loud. |
| 3 | Author B frames. |
| 15 | Reviewer speaks, author B listens and writes. |
| 7 | Dialogue. |
| 5 | **Silent revision commitments.** Each author writes down three specific changes they will make, each with a location in the draft. "Strengthen the framework" is too vague to count. |
...
*Complete one copy per draft you review. Bring the completed form to class and give it to the author at the end of your round.*
...
| **Date** | |
| **Draft title** | |
| **The author's framing question** (fill in during the first three minutes) | |

## 1. Strengths

*What is working, and why? Name at least two things specifically. Point to a page or a section. If one idea in this draft is clearly the author's real contribution, say which one it is, because authors frequently cannot see it and cut it in revision.*

## 2. Framework coherence

*Does the conceptual framework do work in this draft, or does it appear at the beginning and then drop out? Trace one construct from the framework section through the research questions to the analysis plan, and report what happens to it. If it disappears somewhere, say where. If the analysis measures something the framework never introduced, say what.*
...
*Is this a design section or a disclaimer? Ask of the draft: whose data, on what basis, and who bears the cost of being wrong. Note whether the author has identified a group their measures could systematically misrepresent, and whether the response to that risk changes anything about the design. If the ethics discussion could be pasted into a different proposal without editing, that is the finding to report.*

## 5. Actionability

*Who acts, on what, and when? Say whether you can name the decision and the decision maker after reading the draft. If the contribution is scholarly rather than practical, say whether the conversation it contributes to is identified specifically enough that you could name two people in it.*

## 6. One big question

*The single question that would most improve this project if the author worked through it. Write one question rather than a list, and take a minute to choose it.*

## 7. Smaller notes (optional)

*Line-level, citation, APA, and clarity items. Keep these separate from the sections above so the author can sort them by priority. If you have annotated the draft itself, write "see draft" here.*

---

# Author's Revision Commitments

*Filled in by the author at the end of each round. Submit with your forms.*
