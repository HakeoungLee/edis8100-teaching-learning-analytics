...
**My `r` is not 0.258.** If you edited a **Your turn** cell, that is expected and it is the entire point of the exercise. If you did not, restart and run all. The dataset is fixed and published, so a clean run reproduces the same numbers every time, on any machine, for everyone in the room.
...
**I got a different answer than my neighbor.** Compare your **Your turn** settings first. That is almost always the difference, and noticing it is the point of the session.
