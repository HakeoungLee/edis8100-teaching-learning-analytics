...
| **In-class time on this notebook** | About 35 minutes, launched in the hands-on studio block (3:35 to 4:10). This is a launch, not the whole project. The notebook's core path is about 75 more minutes; the memo takes the rest, so plan about three hours outside class, as the Mini Project 2 Brief sets out. |
